...
<body>
    ...
    <div>
        ...
        <asp:Button ID="btnDetect" runat="server" Text="Detect" BorderStyle="Solid" Font-Names="Segoe UI" Font-Size="Large" BackColor="#CCCCCC" BorderColor="#006600" OnClick="btnDetect_Click" />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="btnSwitch" runat="server" Text="Switch" BorderStyle="Solid" Font-Names="Segoe UI" Font-Size="Large" BackColor="#CCCCCC" BorderColor="#006600" OnClick="btnSwitch_Click" />
    ...
    <textarea id="txtInput" name="txtInput" style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: medium; font-weight: normal; border: 2px solid #CCCCCC; resize: none; width: 500px; height: 200px; margin-right: 110px;" runat="server"></textarea>
        <asp:Button ID="btnTranslate" runat="server" Text="Translate" BackColor="#006600" BorderStyle="None" Font-Names="Segoe UI" Font-Size="X-Large" ForeColor="White" OnClick="btnTranslate_Click" />
    <textarea id="txtOutput" name="txtOutput" style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: medium; font-weight: normal; border: 2px solid #CCCCCC; resize: none; width: 500px; height: 200px; margin-left: 110px;" runat="server" readonly="readonly"></textarea>
&nbsp;<p>
